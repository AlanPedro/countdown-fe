...
const EditableTeam: React.FunctionComponent<EditableTeamProps> = (
    {team, index, onDelete, onMoveUp, onMoveDown, arrayLength}
    ) => (
    <StyledEditableTeam>
        <StyledArrows>
        ...
        <Button variant="contained" color="secondary" onClick={() => onDelete()}>X</Button>
    </StyledEditableTeam>
);
